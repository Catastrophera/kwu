...
import GachaGrid from './GachaGrid'
                 ...
                 <div key={tx.id} className="bg-cyber-gray/30 border border-cyber-gray p-4 hover:border-cyber-cyan transition-colors">
                   <div className="flex justify-between items-start mb-2">
                     ...
                     <span className={`text-xs font-bold px-2 py-1 ${
                       tx.payment_status === 'Selesai' ? 'bg-green-900/50 text-green-400 border border-green-500' : 
                       tx.payment_status === 'Proses' ? 'bg-blue-900/50 text-blue-400 border border-blue-500' : 
